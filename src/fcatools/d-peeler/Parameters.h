...
/* 0: the chosen dimension has the smallest number of remaining potential items */
/* 1: the chosen dimension maximizes the quantity of potential items that may be absent after propagation */
...
/* DEBUG_MINIMIZATION turns on the output (on the standard output) of information during the minimization (pre-processing). This option may be enabled by someone who wishes to precisely understand how this minimization is performed on a small data set. */
